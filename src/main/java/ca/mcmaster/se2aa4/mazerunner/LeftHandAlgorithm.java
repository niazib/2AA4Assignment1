...
public class LeftHandAlgorithm implements PathFindingAlgorithm {
    ...
    public LeftHandAlgorithm(MazeNavigator navigator) {
    ...
    private boolean left_hand_algorithm() {
        while(true) {
            if (!solver.move_left()) {
